...
#define ATTR_SEARCH1 0x08000000U
#define ATTR_SEARCH2 0x04000000U
...
#define ATTR_FGMASK  0x000001FFU
#define ATTR_BGMASK  0x0003FE00U
...
void save_clip(void *frontend, wchar_t *, int *, int, char* szFile);
...
#define CONFIG_OPTIONS(X) \
    ...
    /* MultiPutty settings */\
    X(INT, NONE, showtimestamp) \
    X(STR, STR, multiputty) \
    /* Proxy options */ \
...
void nc_paint();
char *create_shortcut(char *section);
void conf_clean_str_strs(Conf *conf, int key);
...
#define MSG_PUTTY_HWND -1
#define MSG_PUTTY_COMMAND   -3
#define MSG_PUTTY_SEARCH_RESULT -4
#define MSG_PUTTY_CONTEXT_MENU -5

#define DATA_PUTTY_ERROR 1789001

#define SEARCH_MATCHCASE 1
#define SEARCH_MATCHWHOLEWORD 2
